const shader = {
  ...
  vec4 colour(float pattern, vec2 distortion1, vec2 distortion2) {
    ...
    vec3 col = vec3(pattern + distortion1.x * 0.8, pattern + distortion2.y * .4 + 0.0*distortion1.x, 0.0*pattern + distortion1.x*0.0);
...
loader.load("Становление/noise.png", function do_something_with_texture(tex) {
    texture = tex;
